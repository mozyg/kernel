...
/* module */
static int gs_module_init(void);
static void gs_module_exit(void);
...
//static void gs_suspend (struct usb_gadget *gadget);
//static void gs_resume (struct usb_gadget *gadget);
...
//int gs_write_req_pending(struct tty_struct *tty) {
...
/* USB_FUNCTION */
static struct usb_function gs_usb_function = {
	.name		= GS_LONG_NAME,
...
#endif /* USB_COMPOSITE_DEVICE */
	{ GS_FUNCTION_STR_ID, "USB Serial Function" },
	{  } /* end of list */
};
...
gs_iad_descriptor = {
	.bLength =		sizeof gs_iad_descriptor,
	.bDescriptorType =	USB_DT_INTERFACE_ASSOCIATION,

	.bFirstInterface =	0,	// composite interface will bump this
	.bInterfaceCount = 	2,	// control + data
	.bFunctionClass =	USB_CLASS_COMM,
	.bFunctionSubClass =	USB_CDC_SUBCLASS_ACM,
	.bFunctionProtocol =	USB_CDC_ACM_PROTO_AT_V25TER,
	.iFunction =		GS_FUNCTION_STR_ID,
};
...
static struct usb_interface_descriptor gs_bulk_interface_desc = {
...
static struct usb_interface_descriptor gs_control_interface_desc = {
	.bLength =		USB_DT_INTERFACE_SIZE,
	.bDescriptorType =	USB_DT_INTERFACE,
...
static struct usb_interface_descriptor gs_data_interface_desc = {
	.bLength =		USB_DT_INTERFACE_SIZE,
	.bDescriptorType =	USB_DT_INTERFACE,
...
static struct usb_descriptor_header *gs_acm_fullspeed_function[] = {
	(struct usb_descriptor_header *) &gs_otg_descriptor,
	(struct usb_descriptor_header *) &gs_iad_descriptor,
...
static struct usb_descriptor_header *gs_acm_highspeed_function[] = {
	(struct usb_descriptor_header *) &gs_otg_descriptor,
	(struct usb_descriptor_header *) &gs_iad_descriptor,
	(struct usb_descriptor_header *) &gs_control_interface_desc,
	(struct usb_descriptor_header *) &gs_header_desc,
...
//
//static wait_queue_head_t gs_suspend_wq;
//
//static int gs_lockout(void)
//{
//	if (gs_device->suspended) {
//		int err;
//		err = wait_event_interruptible(gs_suspend_wq,
//				       gs_device->suspended == 0);
//		if (err < 0)
//			return err;
//	}
//	return 0;
//}
//#else
//static inline int gs_lockout(void)
//{	return 0;
//}
//#endif
...
#ifdef CONFIG_PM_DEVICE_LOCKOUT
	init_waitqueue_head(&gs_suspend_wq);
#endif
...
static int gs_open(struct tty_struct *tty, struct file *file)
{
	...
	//if ((ret = gs_lockout())) {
	//	gs_debug("%s: suspend lockout returned %i\n", __FUNCTION__, ret);
	//	return ret;
	//}
...
#else
// omitted 2.6.18-ish 'flip' change
...
//static void
//gs_suspend (struct usb_gadget *gadget)
//{
//#ifdef USB_COMPOSITE_DEVICE
//	struct usb_composite_dev *cdev = get_gadget_data(gadget);
//	struct gs_dev		 *dev = get_composite_data(cdev);
...
//#endif /* USB_COMPOSITE_DEVICE */
//
//	gs_debug(dev, "suspend\n");
//	dev->suspended = 1;
//}

//static void
//gs_resume (struct usb_gadget *gadget)
//{
//#ifdef USB_COMPOSITE_DEVICE
//	struct usb_composite_dev *cdev = get_gadget_data(gadget);
//	struct gs_dev		 *dev = get_composite_data(cdev);
